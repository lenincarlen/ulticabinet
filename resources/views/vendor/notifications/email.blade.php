...
@php
    ...
    $logoPath = $siteSettings['company_logo'] ?? null;
...
@endphp
<img src="{{ $logoUrl }}" class="logo" alt="{{ config('app.name') }} Logo" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none; height: 75px; max-height: 75px; width: 75px;">
</a>
</td>
</tr>
...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">{{ $line }}</p>
@endforeach

@isset($actionText)
@php
    $color = match ($level ?? 'success') {
        'success', 'error' => $level,
        default => 'primary',
    };
    $buttonBgColor = match ($color) {
        'error' => '#e53e3e',
        'success' => '#38a169',
        default => '#2d3748',
    };
...
<a href="{{ $actionUrl }}" class="button button-primary" target="_blank" rel="noopener" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: {{ $buttonBgColor }}; border-bottom: 8px solid {{ $buttonBgColor }}; border-left: 18px solid {{ $buttonBgColor }}; border-right: 18px solid {{ $buttonBgColor }}; border-top: 8px solid {{ $buttonBgColor }}; word-break: break-all;">{{ $actionText }}</a>
</td>
</tr>
</table>
</td>
