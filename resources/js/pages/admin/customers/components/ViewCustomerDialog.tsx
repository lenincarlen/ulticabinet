                                ...
                                {(customer.latitude && customer.longitude) && (
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 mb-3">
                                            Coordenadas: {customer.latitude}, {customer.longitude}
                                        </p>
                                        <div className="w-full h-80 rounded-lg overflow-hidden border border-gray-200">
                                            <iframe
                                                ...
                                                frameBorder="0"
                                                style={{ border: 0 }}
                                                src={`https://www.openstreetmap.org/export/embed.html?bbox=${(customer.longitude - 0.01)},${(customer.latitude - 0.01)},${(customer.longitude + 0.01)},${(customer.latitude + 0.01)}&layer=mapnik&marker=${customer.latitude},${customer.longitude}`}
                                                allowFullScreen
