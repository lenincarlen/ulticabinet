...
export default function SolutionsCreate() {
    ...
    const breadcrumbs = [
        ...
        { title: "Crear", href: "/admin/solutions/create" },
    ];
            ...
            <div className="p-6 max-w-4xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-2xl font-bold tracking-tight">Crear Nueva Solución</h1>
                    </div>
                </div>
                    ...
                    <Card>
                        <CardContent className="p-6 space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-xs text-gray-400">Recomendado: Logo con fondo transparente (PNG)</p>
